...
const filmSchema = z.object({
  ...
  productions: z.array(
    z.object({
      productionName: z
        ...
        .min(6, {
          message:
            'Il nome deve essere di almeno 6 caratteri',
        })
        .max(40, {
          message:
  ...
  producers: z.array(
    z.object({
      producerName: z
        ...
        .max(40, {
          message:
            'Il nome deve superare i 40 caratteri',
        }),
    })
  ),
  ...
  scenography: z
    ...
    .min(6, {
      message:
        'il nome essere di almeno 6 caratteri',
    })
    .max(40, {
      message:
        'il nome non può superare i 40 caratteri',
  ...
  productionNotes: z
    .union(
      [
        ...
        .min(10, {
          message:
          'le note di produzione devono essere di almeno 10 caratteri',
        })
        .max(300, {
          message:
      ...
      festivalName: z
	    .union(
			[
				...
				.min(10, {
				  message:
					'il nome deve essere di almeno 10 caratteri',
				})
				.max(50, {
				  message:
