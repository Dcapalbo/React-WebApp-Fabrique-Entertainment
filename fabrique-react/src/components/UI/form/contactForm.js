...
const ContactForm = () => {
  ...
  const confirmHandler = (event) => {
    ...
    const enteredNameIsValid =
      !isEmpty(enteredName) && inputLength(enteredName);
    const enteredSurnameIsValid =
      !isEmpty(enteredSurname) && inputLength(enteredSurname);
    const enteredNumberIsValid =
      !isTenCharaters(enteredNumber) && !isEmpty(enteredNumber);
    const enteredEmailIsValid =
      !isEmpty(enteredEmail) &&
      isEmail(enteredEmail) &&
      inputLength(enteredEmail);
      ...
      <form className={classes.form__container}>
        ...
        <div className={classes.form__container__item}>
          ...
          {!formInputsValidity.name && (
            <small>Campo obbligatorio, inserire un nome</small>
          )}
        </div>
        <div className={classes.form__container__item}>
          ...
          {!formInputsValidity.surname && (
            <small>Campo obbligatorio, inserire un cognome</small>
          )}
        </div>
        <div className={classes.form__container__item}>
          ...
          {!formInputsValidity.number && (
            <small>Campo obbligatorio, inserire numero di telefono</small>
          )}
        </div>
        <div className={classes.form__container__item}>
